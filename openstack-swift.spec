...
Patch3:           openstack-swift-constraints.patch
Patch4:           openstack-swift-unittests.patch
Patch5:           openstack-swift-enhlog.patch
Patch6:           openstack-swift-conxfer.patch
...
%patch1 -p1 -b .docmod
%patch2 -p1 -b .nonet
%patch3 -p1 -b .constraints
%patch4 -p1 -b .unittests
%patch5 -p1 -b .enhlog
%patch6 -p1 -b .conxfer
...
%changelog
* Fri Oct 09 2012 Peter Portante <pportant@redhat.com>1.4.8-7
- Update version to 1.4.8-7, pulling in RHS 2.0 install
  features
